...
pipe_clasificacion = joblib.load('clasificacion.pkl') 

st.title("Prediccion de lluvia")


input_features = ["Unnamed: 0", "Date", "Location", "MinTemp", "MaxTemp", "Rainfall", "Evaporation", "Sunshine", 
...
selected_features = [ "Date",  "MinTemp", "MaxTemp", "Rainfall", "Evaporation", "Sunshine", 
"WindGustDir", "WindGustSpeed", "Humidity9am", "Humidity3pm", "Pressure9am", "Pressure3pm", 
...
if submit_button:
    # Predict 
    prediction = pipe_clasificacion.predict(user_input)
